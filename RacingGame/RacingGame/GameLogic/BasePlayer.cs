...
namespace RacingGame.GameLogic
{
    ...
    public class BasePlayer
    {
        ...
        //*** TelemetryData
        protected float m_ThrottlePercent;
        protected float m_BrakesPercent;
        protected float m_Steering;
        protected int m_Dammage;

        public LapData CurrentLapData { get; set; }
        public LapDataTable LapDataTable { get; set; }
        public string m_LapId;

        protected DateTime m_LastTelemetryLog = DateTime.MinValue;
        protected DateTime m_LastTelemetrySend = DateTime.MinValue;


        //protected bool m_HasAccelerated = false;
        //protected bool m_HasBreaked = false;

        protected LapTimeManager m_LapTimeManager;

        public LapTimeManager LapTimeManager
        {
            get { return m_LapTimeManager; }
        }
