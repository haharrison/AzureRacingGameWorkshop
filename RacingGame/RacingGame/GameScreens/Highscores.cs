...
namespace RacingGame.GameScreens
{
    ...
    class Highscores : IGameScreen
    {
        ...
        /// </summary>
        private const int NumOfHighscores = 100,
        ...
        {
            // Init highscores
            highscores = new HighscoreInLevel[NumOfHighscoreLevels, NumOfHighscores];
        ...
        public static int GetRankFromCurrentTime(int level, int timeMilliseconds)
        {
            ...
            for (int num = 0; num < NumOfHighscores; num++)
            {
                if (timeMilliseconds <= highscores[level, num].timeMilliseconds || highscores[level, num].timeMilliseconds == 0)
                    return num;
            }
        ...
        public bool Render()
        {
            ...
            for (int num = 0; num < NumOfHighscores; num++)
            {
                //*** Null check for high scores
                if (highscores[selectedLevel, num].name != null)
                {
                    ...
                    TextureFont.WriteGameTime(xPos3, yPos, highscores[selectedLevel, num].timeMilliseconds, Color.Yellow);
                }
                yPos += lineHeight;
            }
