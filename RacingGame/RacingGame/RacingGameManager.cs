...
namespace RacingGame
{
    ...
    public class RacingGameManager : BaseGame
    {
        ...
        public static TimeSpan ApplicationTime
        {
        ...
        public RacingGameManager()
            : base("Azure Racing Game Workshop")
        {
            ...
            //RacingGameManager.player.Mode = ChaseCamera.CameraMode.TrackCamera;
